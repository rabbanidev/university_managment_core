...
-- AddForeignKey
ALTER TABLE "OfferedCourse" ADD CONSTRAINT "OfferedCourse_semesterRegistrationId_fkey" FOREIGN KEY ("semesterRegistrationId") REFERENCES "semeter_registrations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
